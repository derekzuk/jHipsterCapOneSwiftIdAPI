        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('jhipsterswiftidApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-jhipsterswiftidApp-error');
                                var entityKey = httpResponse.headers('X-jhipsterswiftidApp-params');
                                if (errorHeader) {
